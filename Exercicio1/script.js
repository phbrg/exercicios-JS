function calc() {
    ...
    document.getElementById('saida').innerHTML = `Produto: ${nome}<br>Quantidade de produtos: ${quantidadeP}<br>Quilometros rodados: ${distanciaKm}Km<br>O valor final do frete é de: R$${finalTaxa}<br>Valor pelo peso: ${taxaPeso}<br>Valor por quilometro: ${valorKm}`
